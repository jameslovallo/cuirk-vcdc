export default [
    {
        ...
        description:
            "Christianne Sims, our Vice President and a Detroit native, has lived in Jos. Berry Subdivision for over forty years."
    },
    {
        name: "Edythe Ford",
        description:
    ...
    },
    {
        name: "Robert Gregory",
        description:
            "Rob Gregory, our President, is a native of Detroit and resides in the East Village neighborhood, where he renovated his home in 2022. Rob holds a Bachelor’s in Finance from Michigan State University, a Master’s of Business Administration in Finance and International Business from Wayne State University, and is a Certified Treasury Professional (CTP) Charterholder. Rob has worked his entire professional career in the City of Detroit with Rocket Companies. He has occupied diverse roles within Rocket’s Capital Markets and Finance teams, ranging from bond structuring and trading to overseeing the company's secured funding portfolio. Currently, Rob leads the Pricing Strategy function within Rocket’s Capital Markets Group. Rob has deep familial roots within the villages of Detroit as well as the development of downtown Detroit's parks and urban placemaking. Rob also serves on the board of directors at The East Village Association."
    },
    {
        name: "Steve Economy",
        description:
            "Steve Economy owned and operated Standard Barber Company, a Detroit barbershop for over a decade. He is also the Senior Director of Member Engagement at The Conference Board Human Capital Center, where he collaborates with business leaders to address human capital challenges. A Detroit resident for 10+ years, Steve lives in the Villages with his wife and two boys, ages 7 and 9. Stephen came on the board of the Villages CDC in January of 2025 and currently serves as our board secretary."
    },
    {
        name: "Valeon Waller",
        description:
            "As a native Detroiter, Valeon Waller has been a resident of both West Village and Indian Village for more than 25 years. With a background in healthcare administration and program development, she currently serves as the Community Outreach Coordinator at St. Augustine-St. Monica’s, where she plays a pivotal role in building meaningful coalitions between the organization and the community it serves. With a passion for fostering collaboration and creating positive social impact, Valeon works to ensure the organization's outreach programs resonate with local needs and effectively promote its mission."
    },
    {
        name: "Thea Robbert",
        description:
            "Thea Robbert is a resident of The Villages and works for a local real estate and urban development company. Her interests reside at the intersection of urban planning, architecture, design, and real estate development. As a graduate of Wayne State University, she has lived in the city for many years and was excited to continue living and working in Detroit after graduating. Her skills include financial modeling, asset management, and development. She joined the board in February 2025 and serves as board treasurer."
    },
    {
        name: "Rob Voakes",
        description:
            "As a longtime Detroit advocate, Rob Voakes works as the Program Director at the Villages CDC.  Rob has been working in the city of Detroit for over 20 years, growing up in the backstage areas of our beloved concert venues such as the Fox Theatre, Fisher Theater and Fillmore Detroit.  Rob then went on to be involved in film Detroit, working on many of the large movie productions that came through our city.  In addition, Rob holds a degree in economics and a background in the legal sector, helping large companies and entrepreneurs with intellectual property as well as construction and contract litigation.  Rob is passionate about community development, architecture preservation and inclusive housing policies.  Rob is enthusiastic about making connections with residents and fostering collaboration between the community and the city."
    }
