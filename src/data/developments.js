export default [
	...
	},
	{
      ...
      <ul class="link-list">
        ${[1707, 1711, 1719]
              ...
              <li>
                <a
                  href="/src/images/development/1707-19-fischer/${p}.pdf"
                  target="_blank"
                >
									Render for ${p} Fischer
								</a>
              </li>
            `
					)
	...
	},
	{
      ...
      ${Array(4)
				...
				.map((n, i) => {
					return /* html */ `
          <c-compare percent="50">
            <img src="/src/images/development/9301-kercheval/before-${i}-min.jpeg">
            <img src="/src/images/development/9301-kercheval/after-${i}-min.jpeg">
          </c-compare>
        `
				})
				.join(/* html */ `<br>`)}
